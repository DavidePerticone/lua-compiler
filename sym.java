...
public String[] TT;
	public sym(){
		TT = new String[100];
		TT[35]=new String("FUNCTION");
		TT[10]=new String("SO");
		TT[4]=new String("MAJ");
		TT[33]=new String("REPEAT");
		TT[11]=new String("SC");
		...
		TT[31]=new String("NIL");
		TT[8]=new String("OR");
		TT[21]=new String("DIV");
		TT[34]=new String("UNTIL");
		TT[14]=new String("RO");
		...
		TT[38]=new String("ID");
		TT[0]=new String("EOF");
		TT[36]=new String("RETURN");
		TT[1]=new String("error");
		TT[15]=new String("RC");
		TT[22]=new String("HAT");
		TT[40]=new String("NUMBER");
		TT[16]=new String("BO");
		TT[12]=new String("EQ");
		...
		TT[39]=new String("STRING");
		TT[30]=new String("LOCAL");
		TT[6]=new String("MAJ_EQ");
		TT[37]=new String("PRINT");
		TT[24]=new String("DO");
