...
@.str.6 = private constant [22 x i8] c"---------------------\00", align 1
@.str.7 = private constant [3 x i8] c"\0A \00", align 1
@.str.8 = private constant [6 x i8] c"%.0f \00", align 1
@.str.9 = private constant [3 x i8] c"\0A \00", align 1
@.str.10 = private constant [22 x i8] c"---------------------\00", align 1
@.str.11 = private constant [3 x i8] c"\0A \00", align 1
@.str.12 = private constant [14 x i8] c"Stack is full\00", align 1
@.str.13 = private constant [15 x i8] c"Stack is empty\00", align 1
...
%13 = fsub double %12, 1.0
%14 = load double, double* %5, align 8
%15 = fcmp one double %14, %13
br i1 %15, label %if.body.2, label %if.else.2
if.body.2:
...
%19 = fcmp oeq double %18, 1.0
br i1 %19, label %if.body.3, label %if.else.3
if.body.3:
...
%3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.6, i32 0, i32 0))
%4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.7, i32 0, i32 0))
br label %for.body.4
for.body.4:
...
%9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8, i32 0, i32 0), double %8)
...
for.exit.4:
%15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.9, i32 0, i32 0))
%16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.10, i32 0, i32 0))
...
%21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i32 0, i32 0))
ret double 0.0
...
br i1 %5, label %if.body.5, label %if.else.5
if.body.5:
%6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.12, i32 0, i32 0))
ret double -1.0
br label %if.else.5
if.else.5:
...
br i1 %2, label %if.body.6, label %if.else.6
if.body.6:
%3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.13, i32 0, i32 0))
ret double -1.0
br label %if.else.6
if.else.6:
